...
function displayMessage() {
    ...
    for(let i=0; i<welcomeMessage.length; i++) {
        waiting.innerHTML = '';
        timeoutId = setTimeout( () => waiting.innerHTML += welcomeMessage[i], i*100);
        timeouts.push(timeoutId)
    }
    timeoutId2 = setTimeout( () => waiting.innerHTML += '<span class="waiting">|</span>', welcomeMessage.length*100);
